...
public class AILevel3 extends AIBase implements AIResponseInterface {

    private static final Logger logger = LoggerFactory.getLogger(AILevel3.class);


    private static final AILevel3 instance = new AILevel3();

    private AILevel3() {
    }

    public static AILevel3 getInstance() {
        return instance;
    }
